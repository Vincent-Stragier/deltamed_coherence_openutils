...
from gui_anonymiser_main import Ui_MainWindow
from utils import (
    anonymise_eeg,
    ensure_path,
    list_files,
...
class MainApp(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self):
        ...
        self.actionConfigure_coh3toEDF_exe.triggered.connect(
            self.select_coh3toedf_path,
        )
    ...
    def anonymise(self):
        ...
        # self.ok_changed.emit(False)

    def convert(self):
        """ Convert .eeg to .EDF files. """
        print('Not implemented yet')
        print(self.conversion_origin_path)
        pass
    ...
    def save_preferences(self, path: str = None, executable_path: str = None):
        ...
        if isinstance(executable_path, str) and os.path.isdir(executable_path):
